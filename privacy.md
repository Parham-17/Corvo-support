...
All summarization is performed entirely on your iPhone using Apple's FoundationModels framework (Apple Intelligence). Your text is never sent to any server — Crux's or anyone else's. Processing happens locally, in real time, on your device.
...
Summaries you choose to save are stored locally on your device using Apple's SwiftData framework. This data never leaves your device and is not accessible to anyone other than you.
